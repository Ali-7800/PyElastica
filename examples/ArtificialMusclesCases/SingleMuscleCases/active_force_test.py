...
sim_settings_dict = {
    ...
    "additional_identifier": "_with_k_"
    + str(fiber_connection_settings.k_val)
    + "_with_k_repulsive_"
    + str(fiber_connection_settings.k_repulsive_val)
    + "_with_num_elements_{0}".format(test_muscle.sim_settings.n_elem_per_coil),
...
additional_curve_list = [
    (test_muscle.active_force_curve_2, "Active Force")
]  # ,(test_muscle.active_force_line,"Trendline")
# additional_curve_list = []
