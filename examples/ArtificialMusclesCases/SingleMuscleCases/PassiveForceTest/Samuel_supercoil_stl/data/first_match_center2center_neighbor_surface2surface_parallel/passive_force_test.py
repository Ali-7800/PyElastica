...
#     "separation_distance_list": [1e-6],
#     "decay_factor_list": [2.5e-5],
# }
...
#     "friction_coefficient": 5e-1,
#     "velocity_damping_coefficient": 1e5,
#     "separation_distance_list": [1e-6,3e-6],
#     "decay_factor_list": [2.5e-5,2.5e-8],
# }
...
sim_settings_dict = {
    ...
    "additional_identifier": "with_fiber_k_{0}_decay_factor_{1}_separation_distance_list_{2}".format(
        fiber_connection_settings.k_val_list,
        fiber_connection_settings.decay_factor_list,
        fiber_connection_settings.separation_distance_list,
    ),
...
additional_curve_list = [(test_muscle.passive_list, "Experiments", "k")]
