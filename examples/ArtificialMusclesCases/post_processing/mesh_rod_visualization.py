...
# DATA_PATH = '/Users/ali-7800/Desktop/Research/dev_artificial_muscle/PyElastica/examples/ArtificialMusclesCases/DoubleMuscleCases/AntgonisticArm/Samuel_monocoilSamuel_monocoil/data/Samuel_monocoilSamuel_monocoil.dat'
DATA_PATH = "/Users/ali-7800/Desktop/Research/dev_artificial_muscle/PyElastica/examples/ArtificialMusclesCases/DoubleMuscleCases/AntgonisticArm/Samuel_supercoil_stlSamuel_supercoil_stl/data/Samuel_supercoil_stlSamuel_supercoil_stl.dat"
with open(DATA_PATH, "rb") as fptr:
    data = pk.load(fptr)
# OUTPUT_FILENAME = "pov_antagonistic"
OUTPUT_FILENAME = "pov_antagonistic_arm_supercoil"

OUTPUT_IMAGES_DIR = "frames_super"
...
if __name__ == "__main__":
    ...
    for i in range(len(data) - 1):
        ...
        r.append(np.array(data[i + 1]["radius"]))  # shape: (timelength, 3, num_element)
    ...
    for i in range(len(data) - 1):
        ...
        r[i] = r[i][0] * np.ones_like(
            interpolate.interp1d(times, r[i], axis=0)(times_true)
        )
    faces_rigid_body = interpolate.interp1d(times, faces_rigid_body, axis=0)(times_true)
