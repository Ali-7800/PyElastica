...
# Setup (USER DEFINE)
DATA_PATH = "vessel.dat"  # Path to the simulation data
SAVE_PICKLE = True

# Rendering Configuration (USER DEFINE)
OUTPUT_FILENAME = "pov_vessel"
...
if __name__ == "__main__":
    ...
    base_radius = 0.003*np.ones_like(xs[:, 0, :]) #wire radial profile to distinguish tail from head
    # Rendering
