...
class BaseSimulator(
    BaseSystemCollection, Constraints, Contact, Forcing, CallBacks, Damping
):
    pass
...
class ArmEnvironment:
    ...
    def set_rod(self):
        ...
        self.simulator.dampen(self.shearable_rod).using(
            ...
            damping_constant=damp_coefficient,
    ...
    def set_drag_force(
        self, base_length, base_radius, tip_radius, arm, arm_parameters_dict
    ):
        """Add drag force"""
