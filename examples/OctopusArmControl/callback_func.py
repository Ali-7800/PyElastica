...
class AlgorithmCallBack(BasicCallBackBaseClass):
    ...
    def save_params(self, system, time):
        ...
        self.callback_params["voronoi_dilatation"].append(
            system.static_rod.voronoi_dilatation.copy()
        )
        self.callback_params["position"].append(
            system.static_rod.position_collection.copy()
        )
        self.callback_params["director"].append(
            system.static_rod.director_collection.copy()
        )
...
class OthersCallBack:
    ...
    def save_data(self, **kwargs):
        ...
        with open("simulation_others.pickle", "wb") as others_file:
            data = dict(time_series_data=self.callback_params, **kwargs)
