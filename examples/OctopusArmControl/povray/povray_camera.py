...
class POVRAYCamera:
    def __init__(
        ...
        **kwargs,
        ...
        self.camera_translate = "<%f, %f, %f>" % (
            translate[0],
            translate[1],
            translate[2],
        )
        self.sun_position = "<%f, %f, %f>" % (
            sun_position[0],
            sun_position[1],
            sun_position[2],
        )
        ...
        self.camera_setting += (
            "#declare Camera_Position  = " + self.camera_position + ";\n"
        )
        self.camera_setting += (
            "#declare Camera_Look_At   = " + self.camera_look_at + ";\n"
        )
        self.camera_setting += "#declare Camera_Sky       = " + self.camera_sky + ";\n"
        self.camera_setting += (
            "#declare Camera_Angle     = " + self.camera_angle + ";\n"
        )
        self.camera_setting += (
            "#declare Camera_Rotate    = " + self.camera_rotate + ";\n"
        )
        self.camera_setting += (
            "#declare Camera_Translate = " + self.camera_translate + ";\n"
        )
